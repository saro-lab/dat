...
export const libList: Library[] = [
    ...
    _go('github.com/saro-lab/dat/dat-go/v4', 'v4.7.0', '/libs/go-saro-dat', `${REPO_BASE}/dat-go`),
    _vcpkg('dat', '4.7.0', '/libs/vcpkg-dat', true, `${REPO_BASE}/dat-vcpkg`),
